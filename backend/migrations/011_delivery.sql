...
--
-- Notes: the legacy delivery-marketplace partner integration (Uber Eats /
--   DoorDash / Grubhub) is deliberately absent. BeepBite dispatches its own
--   drivers; it is not a marketplace aggregator client.
--
