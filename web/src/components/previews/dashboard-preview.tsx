...
import { BarChart3, TrendingUp, TrendingDown, DollarSign, Users, ShoppingCart, MessageSquare, Package, Calendar, Download, Activity } from 'lucide-react';
...
interface RecentOrder {
  ...
  customer: string;
  total: number;
  status: 'completed' | 'preparing' | 'ready' | 'confirmed';
  type: 'whatsapp' | 'pos';
  time: string;
}

interface Scenario extends DashboardMetrics {
