...
export default function LiveOrdersPanel({
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'ready':               return 'bg-success/15 text-success border-success/30';
      case 'out_for_delivery':    return 'bg-success/25 text-success border-success/40';
      case 'pending_on_delivery': return 'bg-warning/15 text-warning border-warning/30';
