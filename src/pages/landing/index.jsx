...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section - Clean with strategic orange accents */}
      <section id="home" className="relative py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              {/* Left Content - Orange accents on key elements */}
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button 
                    size="lg" 
                    className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 text-base rounded-lg transition-colors"
                  ...
                  <Button 
                    size="lg" 
                    variant="outline" 
                    className="border-2 border-gray-300 text-gray-700 px-8 py-4 text-base rounded-lg hover:border-orange-500 hover:text-orange-500 transition-colors"
                    onClick={() => navigate('/signup')}
                  >
                    Learn More
                  </Button>
                ...
                {/* Clean trust indicators with orange accent */}
              ...
              {/* Right Visual - Clean with orange accents */}
              <div className="relative">
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-lg">
                    <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                      <div className="flex items-center gap-3">
                        ...
                        <h3 className="font-medium text-gray-900">BeepBite POS</h3>
                      ...
                      <div className="p-4 rounded-lg border border-orange-200 bg-orange-50">
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            <span className="font-semibold text-gray-900">#2847</span>
                            <Badge className="bg-orange-500 text-white text-xs">
                              cooking
                            </Badge>
                          </div>
                          <p className="font-medium text-gray-900">Maria G.</p>
                          <p className="text-sm text-gray-600">2x Spicy Burger, 1x Fries • R180.00</p>
                ...
                {/* Animation steps with orange accents */}
                {heroStep === 1 && (
                  <div className="bg-white rounded-2xl border border-orange-200 overflow-hidden shadow-lg">
                    ...
                    <div className="p-6 text-center space-y-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">Order #2847 Ready!</h3>
                        <p className="text-gray-600">Sending pickup notification via WhatsApp...</p>
                      </div>
                    </div>
                  </div>
                )}
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 p-4 shadow-lg">
                      ...
                      <div className="bg-green-50 rounded-lg p-3 border border-green-200">
                        <div className="text-sm">
                          ...
                          <div className="text-gray-700">Order #2847 (R180.00) is ready for pickup!</div>
        ...
        {/* Trust indicators - Clean with subtle orange */}
        ...
        {/* Features Section - Clean with orange highlights */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, i) => (
                <div key={i} className="bg-white rounded-xl border border-gray-200 p-8 hover:border-orange-200 transition-colors">
                  <div className="mb-6">
        ...
        <section id="product-previews" className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-gray-900">
        ...
        {/* Benefits Section - Clean with orange accents */}
        ...
        {/* How It Works - Clean with orange highlight */}
            ...
            <div className="max-w-2xl mx-auto text-center">
              {steps.map((step, i) => (
                <div key={i} className="bg-white rounded-xl border border-gray-200 p-8">
                  <div className="mb-6">
                    <div className="w-16 h-16 bg-orange-50 rounded-2xl flex items-center justify-center mx-auto text-orange-500">
                      {step.icon}
                    </div>
                  </div>
        ...
        {/* Support Section - Dark with orange accents */}
        <section id="support" className="py-24 bg-gray-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-bold mb-6">Need help?</h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-3">WhatsApp Support</h3>
              ...
              <div className="text-center">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-2 bg-orange-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-orange-600 transition-colors"
                >
                  Email Us
                </a>
              </div>
              ...
              <div className="text-center">
                ...
                <a 
                  href="/docs" 
                  className="inline-flex items-center gap-2 bg-gray-700 text-white px-4 py-2 rounded-lg text-sm hover:bg-gray-600 transition-colors border border-gray-600"
                >
                  View Docs
                </a>
              </div>
        ...
        {/* CTA Section - Orange with clean design */}
        <section id="get-started" className="py-24 bg-orange-500 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
                className="bg-white text-orange-500 hover:bg-gray-50 px-8 py-4 text-lg rounded-lg font-semibold"
                onClick={() => navigate('/signup')}
              >
                Start Free Trial
              </Button>
              <Button 
                size="lg" 
                variant="outline"
                className="border-2 border-white text-white :bg-white hover:text-orange-500 px-8 py-4 text-lg rounded-lg font-semibold"
                onClick={() => navigate('/signup')}
              >
                Get Started
              </Button>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  ...
                  <li><button onClick={() => scrollToSection('product-previews')} className="hover:text-orange-500 transition-colors">Product Previews</button></li>
