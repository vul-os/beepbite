    ...
    <DocsLayout title="Documentation">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-orange-100 bg-gradient-to-br from-orange-50 via-white to-amber-50 p-6 sm:p-10 lg:p-12 mb-12">
        ...
        <div className="relative max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/80 backdrop-blur border border-orange-200 px-3 py-1 text-xs font-semibold text-orange-700 mb-5">
            <Sparkles className="w-3.5 h-3.5" />
            BeepBite Documentation
          </div>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-gray-900 leading-[1.1]">
          ...
          <div className="mt-7 relative max-w-xl">
            ...
            <Input
              ...
              className="pl-10 h-12 text-base bg-white border-gray-200 shadow-sm focus-visible:ring-orange-300"
            />
            <kbd className="hidden sm:inline-flex absolute right-3 top-1/2 -translate-y-1/2 items-center gap-1 text-[11px] font-mono text-gray-400 bg-gray-100 border border-gray-200 px-1.5 py-0.5 rounded">
              ⌘K
            </kbd>
          </div>
        ...
        <section className="mb-14">
          <div className="flex items-end justify-between mb-5 sm:mb-6">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Start here</h2>
            </div>
          </div>
      ...
      <section className="mb-14">
        <div className="flex items-end justify-between mb-5 sm:mb-6">
          <div>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900">All guides</h2>
          </div>
        ...
        {filteredTopics.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-gray-200 p-10 text-center">
            <Compass className="w-6 h-6 mx-auto text-gray-400" />
            <div className="mt-2 text-sm font-semibold text-gray-700">No guides match "{query}"</div>
            <div className="mt-1 text-sm text-gray-500">Try a different search or browse the sidebar.</div>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            {filteredTopics.map((t) => (
              <div
                key={t.title}
                className="group rounded-2xl border border-gray-200 bg-white p-5 sm:p-6 hover:border-orange-200 transition-colors"
              >
                  ...
                  {t.items.map((it) => (
                    <li key={it.to}>
                      ...
                      >
                        ...
                        <span className="flex-1 text-sm font-medium text-gray-800 group-hover/item:text-orange-700 transition-colors truncate">
                          {it.title}
                        </span>
                        {it.badge && (
                        ...
                        <ChevronRight className="w-4 h-4 text-gray-300 group-hover/item:text-orange-500 group-hover/item:translate-x-0.5 transition-all" />
                      </Link>
                    </li>
                  ))}
                </ul>
      ...
      {!query && (
        <section className="mb-14">
          <div className="rounded-3xl border border-gray-200 bg-white p-5 sm:p-8 lg:p-10 grid lg:grid-cols-12 gap-8 items-center">
        ...
        <section className="mb-14">
          <div className="flex items-end justify-between mb-5 sm:mb-6">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Frequently read</h2>
            </div>
          </div>
            ...
            {POPULAR.map((p) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-sm font-semibold text-gray-900 group-hover:text-orange-700 transition-colors truncate">
                    {p.title}
                  </div>
                  <div className="text-xs text-gray-500 mt-0.5">{p.section}</div>
                </div>
      ...
      <section id="troubleshooting" className="mb-12 scroll-mt-24">
        <div className="grid md:grid-cols-2 gap-5">
          <div className="rounded-2xl border border-gray-200 bg-white p-6">
            ...
            <h3 className="text-lg font-bold text-gray-900">Common issues</h3>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              {[
                ...
                <li key={item.q} className="rounded-lg bg-gray-50 border border-gray-100 p-3">
          ...
          <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-orange-50 to-amber-50 p-6">
            <div className="w-10 h-10 rounded-xl bg-white text-orange-600 flex items-center justify-center mb-3 shadow-sm">
              <Mail className="w-5 h-5" />
            </div>
            <h3 className="text-lg font-bold text-gray-900">Talk to a human</h3>
            ...
            <div className="mt-5 grid sm:grid-cols-2 gap-3">
              <a
                ...
                className="rounded-xl bg-white border border-orange-200 p-3 hover:border-orange-300 hover:shadow-sm transition-all"
              >
          ...
          <div className="relative grid md:grid-cols-3 gap-6 items-center">
            ...
            <div className="md:text-right">
              <Button
                size="lg"
                onClick={() => navigate('/signup')}
                className="bg-white text-orange-600 hover:bg-orange-50 font-semibold px-7 py-6 rounded-2xl shadow-xl"
              >
                Start free trial
                <ArrowRight className="w-4 h-4 ml-1.5" />
              </Button>
