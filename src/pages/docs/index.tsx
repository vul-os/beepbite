...
const TOPICS: DocsTopic[] = [
  ...
  },
  {
    ...
    color: 'from-chart-2/15 to-chart-2/5 text-chart-2',
    items: [
  ...
  },
  {
    ...
    color: 'from-chart-5/15 to-chart-5/5 text-chart-5',
    items: [
  ...
  },
  {
    ...
    color: 'from-chart-4/15 to-chart-4/5 text-chart-4',
    items: [
...
const DocsIndex = () => {
  ...
  return (
    <DocsLayout title="Documentation">
      {/* ====== Hero ====== */}
      <section className="relative overflow-hidden rounded-3xl border border-primary/15 bg-gradient-to-br from-primary/5 via-background to-primary/5 p-6 sm:p-10 lg:p-12 mb-12">
        ...
        <div className="relative max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full bg-card/80 backdrop-blur border border-primary/20 px-3 py-1 text-xs font-semibold text-primary mb-5">
          ...
          <div className="mt-7 relative max-w-xl">
            ...
            <Input
              ...
              className="pl-10 h-12 text-base bg-card border-border shadow-sm focus-visible:ring-primary/40"
            />
      ...
      {!query && (
        <section className="mb-14">
          <div className="flex items-end justify-between mb-5 sm:mb-6">
            <div>
              <div className="text-xs font-semibold uppercase tracking-wider text-primary mb-1">Featured</div>
      ...
      <section className="mb-14">
        <div className="flex items-end justify-between mb-5 sm:mb-6">
          <div>
            <div className="text-xs font-semibold uppercase tracking-wider text-primary mb-1">Browse by topic</div>
        ...
        {filteredTopics.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            {filteredTopics.map((t) => (
              <div
                key={t.title}
                className="group rounded-2xl border border-border bg-card p-5 sm:p-6 hover:border-primary/20 transition-colors"
              >
                ...
                <ul className="divide-y divide-border -mx-2">
                  {t.items.map((it) => (
                    <li key={it.to}>
                      <Link
                        to={it.to}
                        className="group/item flex items-center gap-3 px-2 py-2.5 rounded-md hover:bg-primary/10 transition-colors"
                      >
                        <span className="w-7 h-7 rounded-lg bg-primary/10 text-primary flex items-center justify-center group-hover/item:bg-primary/15 transition-colors">
                          {it.icon}
                        </span>
                        <span className="flex-1 text-sm font-medium text-foreground group-hover/item:text-primary transition-colors truncate">
                          {it.title}
                        </span>
                        {it.badge && (
        ...
        <section className="mb-14">
          <div className="rounded-3xl border border-border bg-card p-5 sm:p-8 lg:p-10 grid lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-5">
              <div className="text-xs font-semibold uppercase tracking-wider text-primary mb-1">Tour</div>
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                <Button
                  ...
                  className="border-border hover:border-primary/30 hover:text-primary"
                >
      ...
      {!query && (
        <section className="mb-14">
          <div className="flex items-end justify-between mb-5 sm:mb-6">
            <div>
              <div className="text-xs font-semibold uppercase tracking-wider text-primary mb-1">Popular</div>
          ...
          <div className="rounded-2xl border border-border bg-card divide-y divide-border">
            {POPULAR.map((p) => (
              <Link
                key={p.title}
                to={p.to}
                className="group flex items-center gap-4 px-4 sm:px-5 py-3.5 hover:bg-primary/10/50 transition-colors first:rounded-t-2xl last:rounded-b-2xl"
              >
                <span className="w-9 h-9 rounded-lg bg-gradient-to-br from-primary/10 to-primary/5 text-primary flex items-center justify-center shrink-0">
      ...
      <section id="troubleshooting" className="mb-12 scroll-mt-24">
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div className="rounded-2xl border border-border bg-gradient-to-br from-primary/5 to-primary/10 p-6">
            <div className="w-10 h-10 rounded-xl bg-card text-primary flex items-center justify-center mb-3 shadow-sm">
            ...
            <div className="mt-5 grid sm:grid-cols-2 gap-3">
              <a
                ...
                className="rounded-xl bg-card border border-primary/20 p-3 hover:border-primary/30 hover:shadow-sm transition-all"
              >
              ...
              <a
                ...
                className="rounded-xl bg-card border border-success/20 p-3 hover:border-success/30 hover:shadow-sm transition-all"
              >
                <div className="text-xs text-muted-foreground flex items-center gap-1">
                  <WhatsAppIcon className="w-3 h-3 text-success" />
                  WhatsApp
                </div>
      ...
      <section className="mb-4">
        <div className="rounded-3xl bg-gradient-to-br from-primary via-primary/90 to-primary/80 text-primary-foreground p-6 sm:p-10 relative overflow-hidden">
          ...
          <div className="relative grid md:grid-cols-3 gap-6 items-center">
            ...
            <div className="md:text-right">
              <Button
                size="lg"
                onClick={() => navigate('/signup')}
                className="bg-card text-primary hover:bg-muted font-semibold px-7 py-6 rounded-2xl shadow-xl"
              >
                Start free trial
                <ArrowRight className="w-4 h-4 ml-1.5" />
              </Button>
