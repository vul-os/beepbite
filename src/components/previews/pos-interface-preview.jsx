                  ...
                  >
                    <div className="flex flex-col items-center text-center mb-2">
                      ...
                      <div className="w-full">
                        ...
                        <p className="text-orange-600 font-semibold text-xs mb-1">R{item.price.toFixed(2)}</p>
                      </div>
                    </div>
                    {!item.inStock && (
              ...
              {currentScenario.status === 'payment' && (
                ...
                >
                  <div className="text-center py-3">
                    ...
                    <p className="text-lg font-bold text-gray-900">R{orderTotal.toFixed(2)}</p>
                  </div>
                        ...
                        {cart.slice(0, 4).map((item) => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-orange-600 font-semibold text-xs">R{item.price.toFixed(2)}</p>
                            </div>
                  ...
                  <div className="border-t border-gray-200 pt-3 space-y-3">
                    <div className="space-y-1.5">
                      ...
                      <div className="flex justify-between text-xs">
                        ...
                        <span className="font-medium">R{(orderTotal * 0.15).toFixed(2)}</span>
                      </div>
                      <div className="flex justify-between text-sm font-semibold border-t border-gray-200 pt-1.5">
                        <span>Total</span>
                        <span className="text-orange-600">R{(orderTotal * 1.15).toFixed(2)}</span>
                      </div>
                    </div>
